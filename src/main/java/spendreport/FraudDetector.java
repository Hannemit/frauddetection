...
public class FraudDetector extends KeyedProcessFunction<Long, Transaction, Alert> {
	...
	public void processElement(
		...
		if (lastTransactionWasSmall != null) {
			if (currentAmount > LARGE_AMOUNT) {
				Alert alert = createAlert(accountId);
	...
	private Alert createAlert(long alertId) {
	...
	private void setTimer(Context context) throws Exception {
